local translations = {
    ...
    select_lrc_file_desc = "Choose a lyrics file to load into Stand. Move your lyrics files into Lua Scripts/store/lancescript/lyrics.",
    ...
    dewindow = "Dewindow",
    -- 11.2
    recoveries_root = "Recoveries",
    recoveries = "Recoveries",
    casino_loop = "Casino loop",
    casino_loop_desc = "Turn this on when sitting at a slot machine. This is made for Deity of the Sun, so it is recommended you sit there, but you can try others.\nIt will automatically win and lose to maximize the amount of money you can earn a day in the casino ($50m).\nAlso, you may want to disable the frontend_accept game input while Stand is open for this."
}
